...
if __name__ == "__main__":
    ...
    if len(sys.argv) <= 2:
        print(f"Usage: {sys.argv[0]} <list_of_wav_files.txt> <model.onnx,model2.onnx..> <pred_threshold (0.9999 default)> <consecutive_count_threshold>")
        sys.exit()

    fileList = sys.argv[1]
    models = sys.argv[2]
    predThreshold = 0.9999
    ...
    keyword_model.set_kd_threshold_gw_cnt_advanced(0.99995,5)
