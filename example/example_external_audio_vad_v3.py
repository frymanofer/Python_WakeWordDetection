# example_external_audio_vad_v3.py
import time
...
def mic_dispatcher_thread(keyword_model):
    ...
    try:
        while True:
            ...
            if getattr(keyword_model, "is_listening_vad_v3_stand_alone", False):
                vad_v3_probability = keyword_model.feed_audio_frame_vad_v3(audio_frame)
            ...
            should_print_v3 = vad_v3_probability is not None and vad_v3_probability > VAD_PRINT_THRESHOLD

            if should_print_v1 or should_print_v2 or should_print_v3:
                ...
                v3_text = "N/A" if vad_v3_probability is None else f"{vad_v3_probability * 100:.1f}%"
                print(f"vad_v1={v1_text}  vad_v2={v2_text}  vad_v3={v3_text}")
...
async def main():
    ...
    print(f"Printing VAD values above threshold {VAD_PRINT_THRESHOLD}")
    ...
    try:
        keyword_model.start_vad_v3_external_audio()
    except Exception as e:
        print("vad_v3 could not be started. Install its extra dependencies if needed:", e)
