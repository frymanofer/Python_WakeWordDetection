...
async def main():
    ...
    keyword_detection_models = ["models/hey_look_deep_model_28_08122024.onnx", "models/get_nurse_model_28_01122024.onnx", "models/get_scribe_model_28_25012025.onnx"]
#    keyword_detection_models = ["models/lunafit_done_model_28_07112024.onnx"]
    ...
    license_key = "MTczNDIxMzYwMDAwMA==-tNV5HJ3NTRQCs5IpOe0imza+2PgPCJLRdzBJmMoJvok="
